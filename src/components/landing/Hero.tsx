        ...
        <div className="hero-layout">
          ...
          <div className="hero-stat-stack">
            <div className="hero-stat-item">
              <span className="hero-stat-value">5B+</span>
              <span className="hero-stat-label">views managed</span>
            </div>
            <div className="hero-stat-item">
              <span className="hero-stat-value">$4M+</span>
              <span className="hero-stat-label">/month built</span>
            </div>
            <div className="hero-stat-item">
              <span className="hero-stat-value">50+</span>
              <span className="hero-stat-label">channels scaled</span>
            </div>
            <div className="hero-stat-item">
